...
parser.add_argument('--picture', help='output picture', action="store_true")
args = parser.parse_args()

if args.picture:
    print('output image on')
...
for dirpath, dirnames, filenames in os.walk(DATA_PATH):
    for filename in filenames:
        ...
        if args.picture:
            ...
            cv2.imwrite(os.path.basename(dirpath) + '_' + filename + '_r_origin.jpg', right_img)
        ...
        if args.picture:
            cv2.imwrite(os.path.basename(dirpath) + '_' + filename + '_l.jpg', bones_l)
            cv2.imwrite(os.path.basename(dirpath) + '_' + filename + '_r.jpg', bones_r)
